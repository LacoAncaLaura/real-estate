...
public interface EstateRepository extends JpaRepository<Estate, Long> {
    Page<Estate> findByNameContaining(String partialCity, Pageable pageable);

    Page<Estate> findByNameContainingAndQuantityGreaterThanEqual(String partialCity, int minimumQuantity, Pageable pageable);
